(function() {
  ...
  Tuner = function(audioContext, buffer, bufferFiller) {
    var context, canvas, error, gauss, hp, i, lp, success;
    ...
    success = function(stream) {
      ...
      render = function() {
        ...
        timeWidth = screen.width / buffer.length;
        for (s = _i = 0, _ref = buffer.length; 0 <= _ref ? _i < _ref : _i > _ref; s = 0 <= _ref ? ++_i : --_i) {
          globals.timeWidth = timeWidth;
          globals.buffer = buffer[s];
    ...
    error = function(e) {
      console.log(e);
      console.log('This tuner requires the latest version of Google Chrome with "Web Audio API" enabled in chrome://flags, or a build of Firefox > 20 (currently in development as of February 2013');
